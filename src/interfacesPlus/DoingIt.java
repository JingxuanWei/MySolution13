...
public class DoingIt {
    ...
    private void payableInterfaceDriverTest(){
        ...
        double[] thisWeeksSchedule = {0.0, 0.0, 0.0, 4.0, 0.0, 0.0, 0.0, 2.0};
        payableObjects[ 6 ] = new SalariedPlusOnCallEmployee( "John", "Callin", "555-55-5555", 2000.00,thisWeeksSchedule );
        ((SalariedPlusOnCallEmployee)payableObjects[ 6 ]).addWorkRecord(4.0, 100.0, 3);
        ((SalariedPlusOnCallEmployee)payableObjects[ 6 ]).addWorkRecord(2.0, 200.0, 7);
